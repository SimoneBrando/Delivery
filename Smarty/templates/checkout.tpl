            ...
            <div class="checkout-grid">
                ...
                <section class="payment-method">
                    ...
                    <div class="saved-cards">
                        {foreach from=$savedCards item=card name=cards}
                            <div class="card-option {if $smarty.foreach.cards.first}selected{/if}">
                                <input type="radio" name="payment" id="card{$card.id}" {if $smarty.foreach.cards.first}checked{/if}>
                ...
                <section class="delivery-address">
                    ...
                    <div class="saved-addresses">
                        {foreach from=$savedAddresses item=address name=addresses}
                            <div class="address-option {if $smarty.foreach.addresses.first}selected{/if}">
                                <input type="radio" name="address" id="address{$address.id}" {if $smarty.foreach.addresses.first}checked{/if}>
